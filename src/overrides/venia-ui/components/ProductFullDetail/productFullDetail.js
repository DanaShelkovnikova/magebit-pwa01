...
import defaultClasses from './productFullDetail.module.scss';
import CmsBlock from '@magento/venia-ui/lib/components/CmsBlock';
import ButtonFullWidth from "../../../../components/ButtonFullWidth";
import cartImage from './static/ic_cart.svg';
import Tabs from '@app/components/PageBuilder/Tabs';
...
const ProductFullDetail = props => {
    ...
    const tabProps = {
        ...
        defaultIndex: 0,
        headers: ['Description', 'Attributes'],
        border: 'solid',
        borderColor: '#DFE1E2',
        borderWidth: '1px',
        cssClasses: ['product-tabs']
    };
    ...
    return (
        <Fragment>
            ...
            <Form className={classes.root} onSubmit={handleAddToCart}>
                ...
                <section className={classes.cmsShipping}>
                    <CmsBlock
                        identifiers={'shipping-information'}
                        classes={{ block: '', content: '', root: classes.shippingBlock }}
                    />
                </section>
                ...
                <section className={classes.tabs}>
                    <Tabs {...tabProps}>
                        ...
                        <strong>{productDetails.country_of_manufacture}</strong>
                    </Tabs>
                </section>
            </Form>
        </Fragment>
